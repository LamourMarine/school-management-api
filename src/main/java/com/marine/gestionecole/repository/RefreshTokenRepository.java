...
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Long> {
    ...
    @Transactional
    @Modifying
    @Query("DELETE FROM RefreshToken WHERE revoked = true AND expiryDate < :thresholdDate")
    void deleteExpiredRevokedTokens(@Param("thresholdDate") Instant thresholdDate);
